...
set :magento_deploy_chmod_d, fetch(:magento_deploy_chmod_d, '0500')
set :magento_deploy_chmod_f, fetch(:magento_deploy_chmod_f, '0400')
set :magento_deploy_var_media_chmod_d, fetch(:magento_deploy_var_media_chmod_d, '0700')
set :magento_deploy_var_media_chmod_f, fetch(:magento_deploy_var_media_chmod_f, '0600')